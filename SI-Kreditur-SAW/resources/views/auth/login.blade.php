...
<head>
    ...
    <meta name="description" content="SI Kreditur">
...
<body class="bg-dark">
    ...
    <div class="BANK-SCORE d-flex align-content-center flex-wrap">
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="index.html">
                        <img class="align-content" src="http://127.0.0.1:8000/images/logo.png" alt="">
                    </a>
                </div>
